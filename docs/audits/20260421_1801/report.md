# Argus Full Audit — 20260421_1801

## Fleet
- Equity: **$1,002,851.09** | healthy: True | pause_entries: False
  - usdjpy: pos=LONG age=1s broker=True blocked=False
  - gbpusd: pos=FLAT age=1s broker=True blocked=False
  - cadjpy: pos=FLAT age=1s broker=True blocked=False
- Python procs: 6
- PS procs: 1
...
- yfinance: reachable=True latency=0.47s bars=5
