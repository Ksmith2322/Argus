# Argus Full Audit — 20260426_0419

## Fleet
- Equity: **$11,815.11** | healthy: True | pause_entries: False
  - usdjpy: pos=FLAT age=53s broker=True blocked=False
  - gbpusd: pos=FLAT age=53s broker=True blocked=False
  - cadjpy: pos=FLAT age=53s broker=True blocked=False
- Python procs: 12
- PS procs: 1
...
- Reconciliation: OK ([])
- Apollo forward_returns: 231 lines, 96.3h age (STALE)
...
- yfinance: reachable=True latency=0.38s bars=7
