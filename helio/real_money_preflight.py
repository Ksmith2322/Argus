...
def evaluate_strategy(
    ...
    *,
    ...
    checks: list[CheckResult] = [
        check_in_active_roster(strategy),
        check_allocation_factor_positive(strategy),
        check_disciplined_gate_passes(strategy),
        check_live_evidence_n(strategy, n_min=n_min),
        check_live_pf_band(strategy),
        check_trade_source_is_live(strategy),
        check_capacity_headroom(strategy, multiplier=capacity_multiplier),
        check_real_money_allowlist(strategy),
        check_evidence_epoch_clean(),
        check_killed_strategy_invariant(strategy),
        check_heartbeat_fresh(strategy, max_age_hours=heartbeat_max_age_hours),
