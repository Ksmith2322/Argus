---
name: Fleet snapshot — pre paper-reset 2026-04-22
description: Point-in-time fleet state captured before user reset IBKR paper balance from $1M to $10K. Reference point for post-reset clean-start comparison.
type: project
